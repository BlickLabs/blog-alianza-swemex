...
function shoreditch_scripts() {
	...
	wp_localize_script( 'shoreditch-back-top', 'buttonTitle', array(
		'desc' => esc_html__( 'Back to top', 'shoreditch' ),
	) );

	wp_localize_script( 'shoreditch-navigation', 'screenReaderText', array(
...
function wpdocs_excerpt_more( $more ) {
    return sprintf( '...<a class="read-more" href="%1$s"><button class="read-more-button alianza-font-SourceSansPro-regular">%2$s</button></a>',
        get_permalink( get_the_ID() ),
        __( 'Ver más', 'textdomain' )
    );
}
